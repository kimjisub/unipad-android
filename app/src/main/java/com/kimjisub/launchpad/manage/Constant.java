...
public class Constant {
	...
	public static class BILLING{
		...
		public static final String PRO_TOOLS = "pro_tools";
	}
	
	public static class ADMOB {
		public static final String MAIN_START = "ca-app-pub-1077445788578961/6843593938";
		public static final String MAIN_LIST = "ca-app-pub-1077445788578961/6318023505";
		public static final String PLAY_END = "ca-app-pub-1077445788578961/6242001881";
	}
	
	public static class VUNGLE {
		public static final String APPID = "5bb765239e0522795b6641af";
