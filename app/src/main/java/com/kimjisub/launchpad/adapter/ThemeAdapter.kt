...
class ThemeItem(context: Context, val package_name: String) {
	...
	val icon: Drawable =
		res.getDrawable(res.getIdentifier("$package_name:drawable/theme_ic", null, null))
	val name: String =
		res.getString(res.getIdentifier("$package_name:string/theme_name", null, null))
	val author: String =
		res.getString(res.getIdentifier("$package_name:string/theme_author", null, null))
	val description: String =
		res.getString(res.getIdentifier("$package_name:string/theme_description", null, null))
